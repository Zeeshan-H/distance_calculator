  ...
  Future<bool> _calculateDistance() async {
    try {
      ...
      if (startPlacemark != null && destinationPlacemark != null) {
        ...
        String firstlat = startCoordinates.latitude.toString();
        String firstlong = startCoordinates.longitude.toString();
        String seconlat = destinationCoordinates.latitude.toString();
        String seconlong = destinationCoordinates.longitude.toString();
        String conv1 = firstlat.substring(0, 8);
        String conv2 = firstlong.substring(0, 8);
        String conv3 = seconlat.substring(0, 8);
        String conv4 = seconlong.substring(0, 8);
        lat1 = double.tryParse(conv1);
        lat2 = double.tryParse(conv2);
        lat3 = double.tryParse(conv3);
        lat4 = double.tryParse(conv4);
...
//          );
//        }
            totalDistance = _coordinateDistance(lat1, lat2, lat3, lat4);
        setState(() {
